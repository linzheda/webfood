...
--插入菜
insert into resfood(fname,normprice,realprice,detail,fphoto) values('素丝炒莴笋',22.0,20.0,'营养丰富','500008.jpg');
...
insert into resfood(fname,normprice,realprice,detail,fphoto) values('炒鸡',102.0,100.0,'营养丰富','500026.jpg');
insert into resfood(fname,normprice,realprice,detail,fphoto) values('炖鸡',12.0,10.0,'营养丰富','500033.jpg');
